 ...
 * @date November 2017
 */
public class NetworkSinglePerturbationSimulations {
     ...
     */
        ...
        int index;
        String line="";
        int input,inputState;
        ArrayList<Integer> state1=new ArrayList<Integer>();state1.add(0);state1.add(1);
        FileToWrite fw=new FileToWrite("BreastCancerSinglePerturbations.txt");
        ...
        for(Integer s1: state1){
                for(int i1=0;i1<N;i1++){
                        ...
                        nodeStates[(int) indexDictionary.get("MYC_2")]=0;
                            ...
                            for(int t=0;t<T;t++){
                                if(t==0){nodeStates[input]=inputState;}
                        ...
                        line=nw.getNames()[input]+"="+inputState+"\t"+Apofraction1+"\t"+Apofraction2+"\t"+Apofraction3+"\t"+Apofraction+"\t"+Prolfraction1+"\t"+Prolfraction2+"\t"+Prolfraction3+"\t"+Prolfraction4+"\t"+Prolfraction;
